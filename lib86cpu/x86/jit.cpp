	...
	m_dtor_runner(m_sym_table)
{
	...
	define_absolute(mangle("cpu_abort"), JITEvaluatedSymbol(reinterpret_cast<uintptr_t>(static_cast<void(*)(int32_t, uint8_t *)>(&cpu_abort_proxy)), JITSymbolFlags::Absolute));
