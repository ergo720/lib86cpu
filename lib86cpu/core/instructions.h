...
JIT_API void iret_real_helper(cpu_ctx_t *cpu_ctx, uint8_t size_mode);
...
JIT_API uint32_t divd_helper(cpu_ctx_t *cpu_ctx, uint32_t d);
JIT_API uint32_t divw_helper(cpu_ctx_t *cpu_ctx, uint16_t d);
JIT_API uint32_t divb_helper(cpu_ctx_t *cpu_ctx, uint8_t d);
JIT_API uint32_t idivd_helper(cpu_ctx_t *cpu_ctx, uint32_t d);
JIT_API uint32_t idivw_helper(cpu_ctx_t *cpu_ctx, uint16_t d);
JIT_API uint32_t idivb_helper(cpu_ctx_t *cpu_ctx, uint8_t d);
