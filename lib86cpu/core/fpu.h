...
JIT_API uint32_t fpu_stack_fault_fpatan(cpu_ctx_t *cpu_ctx);
JIT_API uint32_t fpu_stack_fault_fsincos(cpu_ctx_t *cpu_ctx);
JIT_API uint32_t fpu_stack_fault_fxch(cpu_ctx_t *cpu_ctx, uint32_t st_num);
JIT_API uint32_t fpu_stack_fault_fcom1(cpu_ctx_t *cpu_ctx, uint32_t st_num1, uint32_t pops_num);
JIT_API uint32_t fpu_stack_fault_fcom2(cpu_ctx_t *cpu_ctx, uint32_t st_num1, uint32_t st_num2, uint32_t pops_num);
