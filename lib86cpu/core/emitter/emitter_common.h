...
#define CPU_CTX_DR0() offsetof(cpu_ctx_t, regs.dr0)
#define CPU_CTX_DR1() offsetof(cpu_ctx_t, regs.dr1)
#define CPU_CTX_DR2() offsetof(cpu_ctx_t, regs.dr2)
#define CPU_CTX_DR3() offsetof(cpu_ctx_t, regs.dr3)
#define CPU_CTX_DR4() offsetof(cpu_ctx_t, regs.dr4)
#define CPU_CTX_DR5() offsetof(cpu_ctx_t, regs.dr5)
#define CPU_CTX_DR6() offsetof(cpu_ctx_t, regs.dr6)
#define CPU_CTX_DR7() offsetof(cpu_ctx_t, regs.dr7)
...
#define CPU_CTX_MM0() offsetof(cpu_ctx_t, regs.r0.low)
#define CPU_CTX_MM1() offsetof(cpu_ctx_t, regs.r1.low)
#define CPU_CTX_MM2() offsetof(cpu_ctx_t, regs.r2.low)
#define CPU_CTX_MM3() offsetof(cpu_ctx_t, regs.r3.low)
#define CPU_CTX_MM4() offsetof(cpu_ctx_t, regs.r4.low)
#define CPU_CTX_MM5() offsetof(cpu_ctx_t, regs.r5.low)
#define CPU_CTX_MM6() offsetof(cpu_ctx_t, regs.r6.low)
#define CPU_CTX_MM7() offsetof(cpu_ctx_t, regs.r7.low)
#define CPU_CTX_ST() offsetof(cpu_ctx_t, regs.status)
#define CPU_CTX_TAG() offsetof(cpu_ctx_t, regs.tag)
...
#define GET_REG_idx(reg) get_reg_offset(reg)
